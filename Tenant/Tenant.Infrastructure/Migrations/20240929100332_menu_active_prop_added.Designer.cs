...
namespace Tenant.Infrastructure.Migrations
{
    ...
    [Migration("20240929100332_menu_active_prop_added")]
    partial class menu_active_prop_added
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shared.Domain.Aggregates.MenuAggregate.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateUTC")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 29, 10, 3, 31, 731, DateTimeKind.Utc).AddTicks(9396));
                    ...
                    b.Property<DateTime?>("UpdatedDateUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 29, 10, 3, 31, 731, DateTimeKind.Utc).AddTicks(8281));
            ...
            modelBuilder.Entity("Shared.Domain.Aggregates.ProductAggregate.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDateUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 29, 10, 3, 31, 723, DateTimeKind.Utc).AddTicks(1367));
                    ...
                    b.Property<DateTime?>("UpdatedDateUTC")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 9, 29, 10, 3, 31, 723, DateTimeKind.Utc).AddTicks(403));
